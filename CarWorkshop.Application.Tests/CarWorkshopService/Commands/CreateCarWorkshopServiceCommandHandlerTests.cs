...
namespace CarWorkshop.Application.CarWorkshopService.Commands.Tests
{
    public class CreateCarWorkshopServiceCommandHandlerTests
    {
        ...
        [Fact()]
        public async Task Handle_DosentCreateCarWorkshopService_WhenUserIsNotAuthorized()
        {
            // arrange
        ...
        [Fact()]
        public async Task Handle_DosentCreateCarWorkshopService_WhenUserIsNotAuthenticated()
        {
            // arrange
